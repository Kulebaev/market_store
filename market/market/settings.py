...
SECRET_KEY = 'django-insecure-hlu5$oqg#m3vza)bnb_#0)begg=$rl4e*f2*ej)4*w*49=if4o'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'market_order', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'market_order', 'static')]
